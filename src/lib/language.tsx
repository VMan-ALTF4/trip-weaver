...
const vi: Record<string, string> = {
  ...
  ,"Private car": "Xe riêng", "Heritage ticket": "Vé di sản", "Food tastings": "Thưởng thức ẩm thực", "Boat ride": "Đi thuyền", "Alcoholic drinks": "Đồ uống có cồn", "Souvenirs": "Quà lưu niệm"
  ...
  ,"Bus / Coach": "Xe khách", "Cruise": "Du thuyền", "UNESCO": "UNESCO", "Temples": "Đền chùa", "Trekking": "Đi bộ đường dài", "Overnight": "Qua đêm", "Evening": "Buổi tối", "Snorkeling": "Lặn biển", "Family": "Gia đình"
