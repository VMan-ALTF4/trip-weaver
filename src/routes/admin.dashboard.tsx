...
const staff = [
  { name: "Linh T.", role: "Admin", status: "Active" },
  { name: "Minh N.", role: "Moderator", status: "Active" },
  { name: "P. Ong", role: "Staff", status: "Suspended" },
];
            ...
            <tr key={u.name} className="hover:bg-secondary/30">
              ...
              <td className="px-4 py-3">
                <Badge variant="outline" className="gap-1">
                  <Users className="size-3.5" aria-hidden /> {u.role}
                </Badge>
              </td>
              <td className="px-4 py-3">
                <Badge variant="outline" className={u.status === "Active" ? "bg-teal/10 text-teal" : "bg-destructive/10 text-destructive"}>
                  {u.status}
                </Badge>
              </td>
              <td className="px-4 py-3 text-right">
